...
type State = {
  ...
  scriptKeys: string;
  scriptStaticKey: string;
  scriptDynamicKey: string;
  description: string;
};
export function ScriptMediatorProperty(props: Props) {
  ...
  const [selectedKeyType, setSelectedKeyType] = useState<string>("STATIC_KEY");
  const [scriptKeys, setScriptKeys] = useState<string>("");
  const [scriptStaticKey, setScriptStaticKey] = useState<string>("");
  const [scriptDynamicKey, setScriptDynamicKey] = useState<string>("");
  ...
  const handleCancelClick = async () => {
    setSelectedScriptLanguage("js");
    setSelectedScriptType("INLINE");
    setScriptBody("");
    setFunctionName("");
    setSelectedKeyType("STATIC_KEY");
    setScriptKeys("");
    setScriptStaticKey("");
    setScriptDynamicKey("");
    setDescription("");
              ...
              <OverlayTrigger
                ...
                overlay={
                  <Tooltip id="help-tooltip">
                    ...
                    Ruby:
                    <br />
                    Download the jruby-complete-1.3.0.wso22v1.jar file from the
                    WSO2 P2 repository and copy it to the
