...
export function PropertyMediatorProperty(props: Props) {
  ...
  const [selectedPropertyName, setSelectedPropertyName] =
    useState("NewProperty");
  const [selectedPropertyAction, setSelectedPropertyAction] = useState("set");
  const [selectedPropertyDataType, setSelectedPropertyDataType] = useState("");
  const [selectedPropertyScope, setSelectedPropertyScope] = useState("default");
  const [newPropertyName, setNewPropertyName] = useState("");
  const [expressionSelector, setExpressionSelector] = useState("");
  const [valueStringPattern, setValueStringPattern] = useState("");
            ...
            <Form>
              <Form.Group>
                ...
                >
                  ...
                  <option value="ConcurrentConsumers">
                    ConcurrentConsumers
                  </option>
                  ...
                  <option value="REQUEST_HOST_HEADER">
                    REQUEST_HOST_HEADER
                  </option>
                ...
                <OverlayTrigger
                  ...
                  overlay={
                    <Tooltip id="help-tooltip">
                      The action to be performed for the property. Set: If this
                      is selected, the property value is set in the message
                      context. Remove: If this is selected, the property is
                      removed from the message context
                    </Tooltip>
                  }
                >
                  <span className="custom-question-icon">
                ...
                <Form.Label className="PropertyScope">
                  Property Scope
                </Form.Label>
                <Form.Select
                  className="custom-form-control"
