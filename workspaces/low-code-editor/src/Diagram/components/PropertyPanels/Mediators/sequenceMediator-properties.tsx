...
export function SequenceMediatorProperty(props: Props) {
  ...
  const [selectedRSType, setSelectedRSType] = useState("Static");
  const [description, setDescription] = useState("");
  const [staReferenceKey, setStaReferenceKey] = useState("");
  ...
  const handleRSTypeSelectChange = (
            ...
            <Form>
              <Form.Group>
                ...
                {selectedRSType === "Static" && (
                  <>
                    <Form.Label className="StaReferenceKey">
