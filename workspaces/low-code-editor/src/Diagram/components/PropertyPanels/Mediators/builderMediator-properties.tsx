...
type State = {
  messageBuilders: string;
  description: string;
};
export function BuilderMediatorProperty(props: Props) {
  const {
    textDocumentUrl,
    textDocumentFsPath,
  ...
  const [messageBuilders, setMessageBuilders] = useState<string>("");
  ...
  const handleMessageBuilders = (
    event: React.ChangeEvent<HTMLTextAreaElement>
  ) => {
    setMessageBuilders(event.target.value);
  };
    ...
    <>
      ...
      <Modal.Body>
        ...
        <Row className="mb-4">
          ...
          <Form>
            <Form.Group>
              <Form.Label className="MessageBuilders">
                Message Builders
              </Form.Label>
              ...
              <Form.Control
                ...
                readOnly
                value={messageBuilders}
                onChange={handleMessageBuilders}
              />
