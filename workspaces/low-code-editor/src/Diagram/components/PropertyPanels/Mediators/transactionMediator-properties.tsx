...
export function TransactionMediatorProperty(props: Props) {
  const {
    textDocumentUrl,
    textDocumentFsPath,
  ...
  const [selectedAction, setSelectedAction] = useState<string>("Action1");
          ...
          <Form>
            <Form.Group>
              ...
              >
                ...
                <option value="Action7">
                  Use existing or initiate transaction
                </option>
              </Form.Select>
