...
type State = {
  ...
  targetXPath: string;
  staticScriptKey: string;
  dynamicScriptKey: string;
  variables: string;
  description: string;
};
export function XQueryMediatorProperty(props: Props) {
  ...
  const [selectedScriptKeyType, setSelectedScriptKeyType] =
    useState<string>("Static");
  const [targetXPath, setTargetXPath] = useState<string>("");
  const [staticScriptKey, setStaticScriptKey] = useState<string>("");
  const [dynamicScriptKey, setDynamicScriptKey] = useState<string>("");
  ...
  const handleCancelClick = async () => {
    setSelectedScriptKeyType("Static");
    setTargetXPath("");
    setStaticScriptKey("");
    setDynamicScriptKey("");
    setVariables("");
        ...
        <Row className="mb-4">
          ...
          <Form>
            <Form.Group>
              ...
              <OverlayTrigger
                ...
                overlay={
                  <Tooltip id="help-tooltip">
                    ...
                    transformation should be applied. The node is evaluated via
                    an XPath expression. If no value is specified for this
                    parameter, the XQuery transformation is applied to the first
              ...
              <br />
              <Row className="mb-4">
                <Modal.Title className="text-secondary">Variables</Modal.Title>
                <Form>
                  <Form.Group>
