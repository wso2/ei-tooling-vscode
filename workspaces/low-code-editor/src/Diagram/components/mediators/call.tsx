...
import { CallMediatorProperty } from "../PropertyPanels/index";
import {
  ...
  return (
    <>
      ...
      >
        ...
        <path
          d="M191.313 146.165H178.687V122.207L167.639 131.524L160 125.082L185 104L210 125.082L202.361 131.524L191.313 122.207V146.165Z"
          fill="white"
        />
        <rect
          x="178.75"
        ...
        />
        <path
          d="M118.424 292.313V279.687H138.637L130.776 268.639L136.212 261L154 286L136.212 311L130.776 303.361L138.637 292.313H118.424Z"
          fill="white"
        />
        <rect
          x="118.424"
          ...
          width="12.5"
          height="72.4235"
          transform="rotate(90 118.424 279.75)"
          fill="white"
        />
        <path
          d="M334.424 292.313V279.687H354.637L346.776 268.639L352.212 261L370 286L352.212 311L346.776 303.361L354.637 292.313H334.424Z"
          fill="white"
        />
        <rect
          x="334.424"
          ...
          width="12.5"
          height="72.4235"
          transform="rotate(90 334.424 279.75)"
          fill="white"
        />
        <path
          d="M228.687 189.835H241.313V213.793L252.361 204.476L260 210.918L235 232L210 210.918L217.639 204.476L228.687 213.793V189.835Z"
          fill="white"
        />
        <rect
          x="241.25"
          ...
          width="12.5"
          height="85.8353"
          transform="rotate(-180 241.25 189.835)"
          fill="white"
        />
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_57_24"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect1_dropShadow_57_24"
              result="shape"
            />
          </filter>
        </defs>
      ...
      {components}
      {isClicked && (
        <CallMediatorProperty modalOpen={open} modalClose={handleCancelClick} />
      )}
    </>
  );
}
