...
import { BAMMediatorProperty } from "../PropertyPanels/index";
import {
    ...
    <>
      ...
      >
        ...
        <rect
          ...
          width="6"
          height="55.1028"
          transform="rotate(59.3548 243.072 268.641)"
          fill="white"
        />
        <rect
          x="298.275"
          ...
          width="6"
          height="55.1028"
          transform="rotate(131.446 298.275 310.473)"
          fill="white"
        />
        <rect
          x="407.588"
          ...
          width="6"
          height="63"
          transform="rotate(54.9699 407.588 210)"
          fill="white"
        />
        <rect
          x="343.999"
          ...
          width="6"
          height="77.7056"
          transform="rotate(36.2968 343.999 251)"
          fill="white"
        />
      </svg>
      ...
      {components}
      {isClicked && (
        <BAMMediatorProperty modalOpen={open} modalClose={handleCancelClick} />
      )}
    </>
  );
}
