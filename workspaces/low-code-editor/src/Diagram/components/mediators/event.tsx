...
import { EventMediatorProperty } from "../PropertyPanels/index";
import {
...
export function Event(props: SquareProps) {
  ...
  return (
    <>
      ...
      {components}
      {isClicked && (
        <EventMediatorProperty modalOpen={open} modalClose={handleCancelClick} />
      )}
    </>
  );
}
